...
export function buildAssistantPrompt(input: AssistantInput) {
  const isComprehensiveSummary = input.summaryMode === "comprehensive";
  ...
  const summaryInstructions =
    isComprehensiveSummary
      ? [
          ...
          "เป้าหมายคือให้คนที่ไม่เคยอ่านเอกสารเข้าใจเนื้อหาหลัก ลำดับเรื่อง เหตุผล รายละเอียดสำคัญ และข้อสรุปได้ในครั้งเดียว",
          "ห้ามตอบเป็นย่อหน้ายาวก้อนเดียว ห้ามไล่คัดลอก chunk ดิบแบบ ส่วนที่ 1, ส่วนที่ 2 โดยไม่จัดกลุ่มความหมาย",
          "รวม chunks ที่พูดเรื่องเดียวกันให้เป็นหัวข้อเดียว แล้วอธิบายเป็นภาษาคนอ่านง่ายโดยไม่ทิ้งสาระ",
          "ห้ามข้ามรายละเอียดสำคัญ ห้ามสรุปเฉพาะส่วนต้นหรือเฉพาะส่วนที่คล้ายคำถาม ถ้าข้อมูลซ้ำให้รวมความโดยไม่ทิ้งสาระ",
          "ใส่อ้างอิง [เลข] เมื่อกล่าวถึงข้อมูลจาก context และอย่าใช้ citation แทนคำอธิบาย",
          "",
          "รูปแบบคำตอบที่ต้องใช้:",
          "## ภาพรวม",
          "- อธิบายว่าเอกสารนี้เกี่ยวกับอะไร เป้าหมายคืออะไร และประเด็นหลักคืออะไร",
          "## ประเด็นสำคัญทั้งหมด",
          "- สรุปเป็น bullet ที่อ่านแล้วเห็นภาพรวมครบ ไม่ตกหล่นหัวข้อหลัก",
          "## รายละเอียดตามลำดับเอกสาร",
          "### 1. [ตั้งชื่อหัวข้อจากเนื้อหาจริง]",
          "- ใจความสำคัญ:",
          "- รายละเอียดที่ต้องรู้:",
          "- เหตุผล/ผลกระทบ/เงื่อนไข ถ้ามี:",
          "## ข้อสรุป",
          "- สรุปสิ่งที่เอกสารต้องการสื่อหรือผลลัพธ์สุดท้าย",
          "## ข้อจำกัดหรือสิ่งที่ยังไม่ชัดเจน",
          "- ระบุเฉพาะกรณีที่เอกสารมีข้อมูลไม่พอหรือมีประเด็นที่ควรถามต่อ"
        ]
      : [];

  return [
    isComprehensiveSummary
      ? "คุณคือ Trainee Knowledge Assistant ตอบเป็นภาษาไทยแบบเป็นระบบ อ่านง่าย ละเอียดพอให้เข้าใจเอกสาร และอ้างอิงเอกสารเมื่อมี context"
